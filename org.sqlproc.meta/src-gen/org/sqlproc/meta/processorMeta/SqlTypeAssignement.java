 ...
 *   <li>{@link org.sqlproc.meta.processorMeta.SqlTypeAssignement#getSqlSize <em>Sql Size</em>}</li>
...
public interface SqlTypeAssignement extends EObject
{
   ...
   * @see #setSqlSize(String)
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getSqlTypeAssignement_SqlSize()
   * @model
   * @generated
   */
  String getSqlSize();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.SqlTypeAssignement#getSqlSize <em>Sql Size</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
