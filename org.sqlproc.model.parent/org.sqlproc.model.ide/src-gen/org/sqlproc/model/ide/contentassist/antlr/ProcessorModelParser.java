 ...
 */
package org.sqlproc.model.ide.contentassist.antlr;
...
import org.sqlproc.model.ide.contentassist.antlr.internal.InternalProcessorModelParser;
...
public class ProcessorModelParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalProcessorModelParser createParser() {
		InternalProcessorModelParser result = new InternalProcessorModelParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPojoAttributeAccess().getKindAlternatives_3_0(), "rule__PojoAttribute__KindAlternatives_3_0");
					...
					put(grammarAccess.getAnnotationAssignementAccess().getGroup(), "rule__AnnotationAssignement__Group__0");
					put(grammarAccess.getAnnotationAssignementAccess().getGroup_2(), "rule__AnnotationAssignement__Group_2__0");
					put(grammarAccess.getAnnotationAssignementAccess().getGroup_3(), "rule__AnnotationAssignement__Group_3__0");
					...
					put(grammarAccess.getPojogenPropertyAccess().getGroup_47(), "rule__PojogenProperty__Group_47__0");
					put(grammarAccess.getPojogenPropertyAccess().getGroup_48(), "rule__PojogenProperty__Group_48__0");
					put(grammarAccess.getPojogenPropertyAccess().getGroup_49(), "rule__PojogenProperty__Group_49__0");
					put(grammarAccess.getPojogenPropertyAccess().getGroup_50(), "rule__PojogenProperty__Group_50__0");
					...
					put(grammarAccess.getDaogenPropertyAccess().getGroup_12(), "rule__DaogenProperty__Group_12__0");
					...
					put(grammarAccess.getAnnotationDefinitionModelAccess().getGroup(), "rule__AnnotationDefinitionModel__Group__0");
					put(grammarAccess.getAnnotationDefinitionModelAccess().getGroup_2_0(), "rule__AnnotationDefinitionModel__Group_2_0__0");
					...
					put(grammarAccess.getAnnotatedFeatureAccess().getGroup(), "rule__AnnotatedFeature__Group__0");
					...
					put(grammarAccess.getPojoProcedureAccess().getGroup_6(), "rule__PojoProcedure__Group_6__0");
					put(grammarAccess.getPojoProcedureAccess().getGroup_6_1(), "rule__PojoProcedure__Group_6_1__0");
					...
					put(grammarAccess.getArtifactsAccess().getAnnotationsAssignment_1_2(), "rule__Artifacts__AnnotationsAssignment_1_2");
					put(grammarAccess.getArtifactsAccess().getTablesAssignment_1_3(), "rule__Artifacts__TablesAssignment_1_3");
					put(grammarAccess.getArtifactsAccess().getProceduresAssignment_1_4(), "rule__Artifacts__ProceduresAssignment_1_4");
					put(grammarAccess.getArtifactsAccess().getFunctionsAssignment_1_5(), "rule__Artifacts__FunctionsAssignment_1_5");
					put(grammarAccess.getArtifactsAccess().getPackagesAssignment_1_6(), "rule__Artifacts__PackagesAssignment_1_6");
					...
					put(grammarAccess.getSqlTypeAssignementAccess().getSqlSizeAssignment_1_1(), "rule__SqlTypeAssignement__SqlSizeAssignment_1_1");
					...
					put(grammarAccess.getAnnotationAssignementAccess().getAnnotationsAssignment_0(), "rule__AnnotationAssignement__AnnotationsAssignment_0");
					put(grammarAccess.getAnnotationAssignementAccess().getAnnotationsAssignment_1(), "rule__AnnotationAssignement__AnnotationsAssignment_1");
					put(grammarAccess.getAnnotationAssignementAccess().getDbTablesAssignment_2_1(), "rule__AnnotationAssignement__DbTablesAssignment_2_1");
					put(grammarAccess.getAnnotationAssignementAccess().getDbNotTablesAssignment_3_1(), "rule__AnnotationAssignement__DbNotTablesAssignment_3_1");
					...
					put(grammarAccess.getPropertyAccess().getNameAssignment_1_13(), "rule__Property__NameAssignment_1_13");
					put(grammarAccess.getPropertyAccess().getNameAssignment_1_14(), "rule__Property__NameAssignment_1_14");
					...
					put(grammarAccess.getPojogenPropertyAccess().getDbColumnAssignment_45_1(), "rule__PojogenProperty__DbColumnAssignment_45_1");
					put(grammarAccess.getPojogenPropertyAccess().getColumnAnnotationsAssignment_45_2(), "rule__PojogenProperty__ColumnAnnotationsAssignment_45_2");
					put(grammarAccess.getPojogenPropertyAccess().getNameAssignment_46_0(), "rule__PojogenProperty__NameAssignment_46_0");
					put(grammarAccess.getPojogenPropertyAccess().getDbColumnAssignment_46_1(), "rule__PojogenProperty__DbColumnAssignment_46_1");
					put(grammarAccess.getPojogenPropertyAccess().getColumnAnnotationsAssignment_46_2(), "rule__PojogenProperty__ColumnAnnotationsAssignment_46_2");
					put(grammarAccess.getPojogenPropertyAccess().getNameAssignment_47_0(), "rule__PojogenProperty__NameAssignment_47_0");
					put(grammarAccess.getPojogenPropertyAccess().getColumnAnnotationsAssignment_47_1(), "rule__PojogenProperty__ColumnAnnotationsAssignment_47_1");
					put(grammarAccess.getPojogenPropertyAccess().getNameAssignment_48_0(), "rule__PojogenProperty__NameAssignment_48_0");
					put(grammarAccess.getPojogenPropertyAccess().getColumnAnnotationsAssignment_48_1(), "rule__PojogenProperty__ColumnAnnotationsAssignment_48_1");
					put(grammarAccess.getPojogenPropertyAccess().getNameAssignment_49_0(), "rule__PojogenProperty__NameAssignment_49_0");
					...
					put(grammarAccess.getMetagenPropertyAccess().getDbNotTablesAssignment_22_2_1(), "rule__MetagenProperty__DbNotTablesAssignment_22_2_1");
					...
					put(grammarAccess.getDaogenPropertyAccess().getNameAssignment_12_0(), "rule__DaogenProperty__NameAssignment_12_0");
					put(grammarAccess.getDaogenPropertyAccess().getColumnAnnotationsAssignment_12_1(), "rule__DaogenProperty__ColumnAnnotationsAssignment_12_1");
					...
					put(grammarAccess.getAnnotationDefinitionModelAccess().getNameAssignment_1(), "rule__AnnotationDefinitionModel__NameAssignment_1");
					put(grammarAccess.getAnnotationDefinitionModelAccess().getClassAssignment_2_0_2(), "rule__AnnotationDefinitionModel__ClassAssignment_2_0_2");
					put(grammarAccess.getAnnotationDefinitionModelAccess().getClassxAssignment_2_1(), "rule__AnnotationDefinitionModel__ClassxAssignment_2_1");
					...
					put(grammarAccess.getPojoEntityAccess().getFeaturesAssignment_7(), "rule__PojoEntity__FeaturesAssignment_7");
					put(grammarAccess.getAnnotatedFeatureAccess().getAnnotationsAssignment_0(), "rule__AnnotatedFeature__AnnotationsAssignment_0");
					put(grammarAccess.getAnnotatedFeatureAccess().getFeatureAssignment_1(), "rule__AnnotatedFeature__FeatureAssignment_1");
					...
					put(grammarAccess.getPojoAttributeAccess().getDirectivesAssignment_0(), "rule__PojoAttribute__DirectivesAssignment_0");
					put(grammarAccess.getPojoAttributeAccess().getFinalAssignment_1(), "rule__PojoAttribute__FinalAssignment_1");
					put(grammarAccess.getPojoAttributeAccess().getStaticAssignment_2(), "rule__PojoAttribute__StaticAssignment_2");
					put(grammarAccess.getPojoAttributeAccess().getKindAssignment_3(), "rule__PojoAttribute__KindAssignment_3");
					put(grammarAccess.getPojoAttributeAccess().getTypeAssignment_4(), "rule__PojoAttribute__TypeAssignment_4");
					put(grammarAccess.getPojoAttributeAccess().getArrayAssignment_5(), "rule__PojoAttribute__ArrayAssignment_5");
					...
					put(grammarAccess.getPojoProcedureAccess().getFinalAssignment_0(), "rule__PojoProcedure__FinalAssignment_0");
					put(grammarAccess.getPojoProcedureAccess().getStaticAssignment_1(), "rule__PojoProcedure__StaticAssignment_1");
					put(grammarAccess.getPojoProcedureAccess().getTypeAssignment_3(), "rule__PojoProcedure__TypeAssignment_3");
					put(grammarAccess.getPojoProcedureAccess().getNameAssignment_4(), "rule__PojoProcedure__NameAssignment_4");
					put(grammarAccess.getPojoProcedureAccess().getParamsAssignment_6_0(), "rule__PojoProcedure__ParamsAssignment_6_0");
					put(grammarAccess.getPojoProcedureAccess().getParamsAssignment_6_1_1(), "rule__PojoProcedure__ParamsAssignment_6_1_1");
					put(grammarAccess.getPojoProcedureAccess().getBodyAssignment_8(), "rule__PojoProcedure__BodyAssignment_8");
					...
					put(grammarAccess.getDaoEntityAccess().getFeaturesAssignment_7(), "rule__DaoEntity__FeaturesAssignment_7");
