...
/**
 * Integration test for POJO and DAO generation with UUID_ENTITY DDL against H2 in-memory database.
 */
public class MainH2IntegrationTest {
    ...
    private static final String EXPECTED_POJO =
        ...
        "        #Required\n" +
        "        #Attr ContactCtype ctype // integer(10)\n" +
        "        #IsDef\n" +
        "        #Attr String address // character varying(100)\n" +
        "        #IsDef\n" +
        "        #Attr String phoneNumber // character varying(100)\n" +
        "    }\n" +
        "\n" +
        ...
        "        #Attr Long id // bigint(19)\n" +
        "        #Required\n" +
        "        #Attr String firstName // character varying(100)\n" +
        "        #Required #Index\n" +
        "        #Attr String lastName // character varying(100)\n" +
        "        #IsDef\n" +
        "        #Attr java.time.LocalDate dateOfBirth // date(10)\n" +
        "        #Required\n" +
        "        #Attr PersonGender gender // character varying(1)\n" +
        "        #IsDef\n" +
        "        #Attr String ssn // character varying(100)\n" +
        "        #ToInit\n" +
        ...
        "        #Attr Long id // bigint(19)\n" +
        "        #IsDef\n" +
        "        #Attr java.util.UUID tUuid // uuid(16)\n" +
        "        #IsDef\n" +
        "        #Attr java.time.OffsetDateTime tOffsetDateTime // timestamp with time zone(32)\n" +
        "    }\n" +
        "\n" +
        "    #Operators #Serializable(1) #Equals(id) #HashCode(id) #ToString(id,myid,name,description)\n" +
        "    #Pojo UuidEntity {\n" +
        "        #PrimaryKey #Index\n" +
        "        #Attr java.util.UUID id // uuid(16)\n" +
        "        #Required\n" +
        "        #Attr java.util.UUID myid // uuid(16)\n" +
        "        #Required\n" +
        "        #Attr String name // character varying(100)\n" +
        "        #IsDef\n" +
        "        #Attr String description // character varying(500)\n" +
        "    }\n";
    // @formatter:on
    ...
    private static final String DEFINITIONS =
        ...
        "database-has-url \"jdbc:h2:mem:testmodel;DB_CLOSE_DELAY=-1\";\n" +
        "database-login-username sa;\n" +
        "database-login-password \"\";\n" +
        "database-in-catalog TESTMODEL;\n" +
    ...
    public void setUp() throws Exception {
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:h2:mem:testmodel;DB_CLOSE_DELAY=-1", "sa", "");
        } catch (Exception e) {
            System.err.println(
    ...
    public void testGeneratePojoForAllTables() throws Exception {
        ...
        try {
            java.nio.file.Files.write(java.nio.file.Paths.get("target/generated-pojo-h2.model"),
                    pojoDefinitions.getBytes(java.nio.charset.StandardCharsets.UTF_8));
            System.out.println("Generated POJO written to: target/generated-pojo-h2.model");
        } catch (Exception e) {
...
//        ignoredStatements.add("UuidEntity");
        ...
        // Write to file for debugging
        try {
            java.nio.file.Files.write(java.nio.file.Paths.get("target/generated-dao-h2.model"),
                    daoDefinitions.getBytes(java.nio.charset.StandardCharsets.UTF_8));
            System.out.println("Generated DAO written to: target/generated-dao-h2.model");
        } catch (Exception e) {
            System.err.println("Could not write debug file: " + e.getMessage());
        }
