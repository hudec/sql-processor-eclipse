    ...
    final Procedure1<JvmGenericType> _function_1 = new Procedure1<JvmGenericType>() {
      ...
      public void apply(final JvmGenericType it) {
        ...
        if (_notEquals) {
          ...
          DaoJvmModelInferrer.this._processorTypesBuilder.<JvmTypeReference>operator_add(_superTypes_2, _typeRef_1);
        }
        ...
        for (final DaoDirective dir : _directives) {
          if ((dir instanceof DaoDirectiveCrud)) {
            ...
            if ((dir instanceof DaoDirectiveQuery)) {
              ...
              DaoJvmModelInferrer.this.inferCountIfx(entity, ((DaoDirectiveQuery) dir), entityType, simpleName, pojo, pojoType, _members_7, moreResultClasses);
            } else {
              if ((dir instanceof DaoFunProcDirective)) {
                ...
                DaoJvmModelInferrer.this.inferFunctionProcedureIfx(entity, _type, _paramlist, entityType, simpleName, _members_8);
              }
            }
          }
        }
      ...
      public void apply(final JvmGenericType it) {
        ...
        for (final Implements impl : _implements) {
          ...
          if (_isGenerics) {
            ...
            final JvmTypeReference ref = DaoJvmModelInferrer.this._typeReferenceBuilder.typeRef(name, _typeRef_2);
            EList<JvmTypeReference> _superTypes_2 = it.getSuperTypes();
            DaoJvmModelInferrer.this._processorTypesBuilder.<JvmTypeReference>operator_add(_superTypes_2, ref);
          } else {
        ...
        for (final DaoDirective dir : _directives) {
          if ((dir instanceof DaoDirectiveCrud)) {
            ...
            if ((dir instanceof DaoDirectiveQuery)) {
              ...
              DaoJvmModelInferrer.this.inferCount(entity, ((DaoDirectiveQuery) dir), entityType, simpleName, pojo, pojoType, _members_14, moreResultClasses);
            } else {
              if ((dir instanceof DaoFunProcDirective)) {
                FunProcType _type = ((DaoFunProcDirective) dir).getType();
                DaoDirectiveParameters _paramlist = ((DaoFunProcDirective) dir).getParamlist();
                EList<JvmMember> _members_15 = it.getMembers();
                DaoJvmModelInferrer.this.inferFunctionProcedure(entity, _type, _paramlist, entityType, simpleName, _members_15);
              }
            }
          }
        }
  ...
  public void inferQuery(final DaoEntity entity, final DaoDirectiveQuery dir, final JvmGenericType entityType, final String simpleName, final PojoEntity pojo, final JvmGenericType pojoType, final List<JvmMember> members, final Map<String, Map<String, JvmParameterizedTypeReference>> moreResultClasses) {
    ...
    final Procedure1<JvmOperation> _function = new Procedure1<JvmOperation>() {
      ...
      public void apply(final JvmOperation it) {
        ...
        DaoJvmModelInferrer.this._processorTypesBuilder.<JvmFormalParameter>operator_add(_parameters_3, _parameter_3);
        StringConcatenationClient _client = new StringConcatenationClient() {
          @Override
          protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
            _builder.append("if (logger.isTraceEnabled()) {");
    ...
    final Procedure1<JvmOperation> _function = new Procedure1<JvmOperation>() {
      ...
      public void apply(final JvmOperation it) {
        ...
        for (final JvmParameterizedTypeReference in : _ins) {
          ...
          JvmFormalParameter _parameter_1 = DaoJvmModelInferrer.this._processorTypesBuilder.toParameter(entity, _firstLower, _typeRef_1);
          DaoJvmModelInferrer.this._processorTypesBuilder.<JvmFormalParameter>operator_add(_parameters_1, _parameter_1);
        }
        EList<JvmFormalParameter> _parameters_2 = it.getParameters();
        JvmTypeReference _typeRef_2 = DaoJvmModelInferrer.this._typeReferenceBuilder.typeRef(DaoJvmModelInferrer.this.SQL_CONTROL);
    ...
    final Procedure1<JvmOperation> _function_1 = new Procedure1<JvmOperation>() {
      ...
      public void apply(final JvmOperation it) {
        ...
        for (final JvmParameterizedTypeReference in : _ins) {
          ...
          JvmFormalParameter _parameter = DaoJvmModelInferrer.this._processorTypesBuilder.toParameter(entity, _firstLower, _typeRef);
          DaoJvmModelInferrer.this._processorTypesBuilder.<JvmFormalParameter>operator_add(_parameters, _parameter);
        }
        EList<JvmFormalParameter> _parameters_1 = it.getParameters();
        JvmTypeReference _typeRef_1 = DaoJvmModelInferrer.this._typeReferenceBuilder.typeRef(DaoJvmModelInferrer.this.SQL_CONTROL);
