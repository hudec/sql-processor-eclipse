    ...
    final Procedure1<JvmOperation> _function = (JvmOperation it) -> {
      ...
      StringConcatenationClient _client = new StringConcatenationClient() {
        ...
        protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
          ...
          _builder.append("}");
          _builder.newLine();
          _builder.append("String sqlName = (sqlControl != null && sqlControl.getSqlName() != null) ? sqlControl.getSqlName() : \"INSERT_");
          String _name = pojo.getName();
    ...
    final Procedure1<JvmOperation> _function = (JvmOperation it) -> {
      ...
      StringConcatenationClient _client = new StringConcatenationClient() {
        ...
        protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
          ...
          _builder.append("}");
          _builder.newLine();
          _builder.append("String sqlName = (sqlControl != null && sqlControl.getSqlName() != null) ? sqlControl.getSqlName() : \"UPDATE_");
          String _name = pojo.getName();
          String _dbName = DaoJvmModelInferrer.this._processorGeneratorUtils.dbName(_name);
          _builder.append(_dbName, "");
          _builder.append("\";");
