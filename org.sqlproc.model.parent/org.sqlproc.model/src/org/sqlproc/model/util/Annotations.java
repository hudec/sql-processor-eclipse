...
public class Annotations {
    ...
    public StringBuilder getConflictAnnotationsDefinitions(String pojoName, ISerializer serializer,
            boolean simpleNames) {
    ...
    public StringBuilder getAttributeAnnotationsDefinitions(String pojoName, String featureName, ISerializer serializer,
            boolean simpleNames, boolean nonStandardAnnotations) {
        return getAnnotationsDefinitions(pojoName, featureName, serializer, simpleNames, attributeAnnotations,
                "#Attribute");
    }

    public StringBuilder getProcedureAnnotationsDefinitions(String pojoName, String featureName, ISerializer serializer,
            boolean simpleNames, boolean nonStandardAnnotations) {
    ...
    public boolean isNonStandardPojoAnnotations(String pojoName, String featureName) {
        return (getterAnnotations.containsKey(pojoName) && getterAnnotations.get(pojoName).containsKey(featureName)
                && !getterAnnotations.get(pojoName).get(featureName).isEmpty())
                || (setterAnnotations.containsKey(pojoName) && setterAnnotations.get(pojoName).containsKey(featureName)
                        && !setterAnnotations.get(pojoName).get(featureName).isEmpty());
    }
    ...
    public static void grabAnnotations(AnnotatedEntity apojo, Annotations as) {
        ...
        String name = (pojo != null) ? pojo.getName()
                : (epojo != null) ? epojo.getName() : (dao != null) ? dao.getName() : null;
        if (name == null)
            return;
