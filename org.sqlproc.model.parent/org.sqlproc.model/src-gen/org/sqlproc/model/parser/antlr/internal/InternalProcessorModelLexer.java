...
public class InternalProcessorModelLexer extends Lexer {
    ...
    public final void mRULE_LPAREN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProcessorModel.g:18123:13: ( '(' )
            // InternalProcessorModel.g:18123:15: '('
            {
            match('('); 
    ...
    public final void mRULE_RPAREN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProcessorModel.g:18125:13: ( ')' )
            // InternalProcessorModel.g:18125:15: ')'
            {
            match(')'); 
    ...
    public final void mRULE_COMMA() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProcessorModel.g:18127:12: ( ',' )
            // InternalProcessorModel.g:18127:14: ','
            {
            match(','); 
    ...
    public final void mRULE_EQUALS() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProcessorModel.g:18129:13: ( '=' )
            // InternalProcessorModel.g:18129:15: '='
            {
            match('='); 
    ...
    public final void mRULE_HEX() throws RecognitionException {
        try {
            int _type = RULE_HEX;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProcessorModel.g:18131:10: ( ( '0x' | '0X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+ ( '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) ) )? )
            // InternalProcessorModel.g:18131:12: ( '0x' | '0X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+ ( '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) ) )?
            {
            // InternalProcessorModel.g:18131:12: ( '0x' | '0X' )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // InternalProcessorModel.g:18131:13: '0x'
                    {
                    match("0x"); 
                    ...
                    break;
                case 2 :
                    // InternalProcessorModel.g:18131:18: '0X'
                    {
                    match("0X"); 
            ...
            // InternalProcessorModel.g:18131:24: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
            ...
            // InternalProcessorModel.g:18131:58: ( '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) ) )?
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // InternalProcessorModel.g:18131:59: '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) )
                    {
                    match('#'); 
                    // InternalProcessorModel.g:18131:63: ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) )
                    int alt3=2;
                    ...
                    switch (alt3) {
                        case 1 :
                            // InternalProcessorModel.g:18131:64: ( 'b' | 'B' ) ( 'i' | 'I' )
                            {
                            ...
                            break;
                        case 2 :
                            // InternalProcessorModel.g:18131:84: ( 'l' | 'L' )
                            {
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProcessorModel.g:18133:10: ( '0' .. '9' ( '0' .. '9' | '_' )* )
            // InternalProcessorModel.g:18133:12: '0' .. '9' ( '0' .. '9' | '_' )*
            {
            matchRange('0','9'); 
            // InternalProcessorModel.g:18133:21: ( '0' .. '9' | '_' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_DECIMAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProcessorModel.g:18135:14: ( RULE_INT ( ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT )? ( ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' ) | ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' ) )? )
            // InternalProcessorModel.g:18135:16: RULE_INT ( ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT )? ( ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' ) | ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' ) )?
            {
            mRULE_INT(); 
            // InternalProcessorModel.g:18135:25: ( ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT )?
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalProcessorModel.g:18135:26: ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT
                    {
                    ...
                    // InternalProcessorModel.g:18135:36: ( '+' | '-' )?
                    int alt6=2;
            ...
            // InternalProcessorModel.g:18135:58: ( ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' ) | ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' ) )?
            int alt8=3;
            ...
            switch (alt8) {
                case 1 :
                    // InternalProcessorModel.g:18135:59: ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' )
                    {
                    if ( input.LA(1)=='B'||input.LA(1)=='b' ) {
                        input.consume();
                    ...
                    break;
                case 2 :
                    // InternalProcessorModel.g:18135:87: ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' )
                    {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProcessorModel.g:18137:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' | '0' .. '9' )* )
            // InternalProcessorModel.g:18137:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' | '0' .. '9' )*
            {
            // InternalProcessorModel.g:18137:11: ( '^' )?
            int alt9=2;
            ...
            // InternalProcessorModel.g:18137:44: ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' | '0' .. '9' )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProcessorModel.g:18139:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* ( '\"' )? | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* ( '\\'' )? ) )
            // InternalProcessorModel.g:18139:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* ( '\"' )? | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* ( '\\'' )? )
            {
            // InternalProcessorModel.g:18139:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* ( '\"' )? | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* ( '\\'' )? )
            int alt15=2;
            ...
            switch (alt15) {
                case 1 :
                    // InternalProcessorModel.g:18139:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* ( '\"' )?
                    {
                    match('\"'); 
                    // InternalProcessorModel.g:18139:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop11:
                    do {
                        int alt11=3;
                        ...
                        switch (alt11) {
                    	case 1 :
                    	    // InternalProcessorModel.g:18139:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalProcessorModel.g:18139:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    // InternalProcessorModel.g:18139:44: ( '\"' )?
                    int alt12=2;
                    ...
                    break;
                case 2 :
                    // InternalProcessorModel.g:18139:49: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* ( '\\'' )?
                    {
                    match('\''); 
                    // InternalProcessorModel.g:18139:54: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop13:
                    do {
                        int alt13=3;
                        ...
                        switch (alt13) {
                    	case 1 :
                    	    // InternalProcessorModel.g:18139:55: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalProcessorModel.g:18139:62: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
                    ...
                    // InternalProcessorModel.g:18139:79: ( '\\'' )?
                    int alt14=2;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProcessorModel.g:18141:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalProcessorModel.g:18141:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalProcessorModel.g:18141:24: ( options {greedy=false; } : . )*
            loop16:
            do {
                int alt16=2;
                ...
                switch (alt16) {
            	case 1 :
            	    // InternalProcessorModel.g:18141:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProcessorModel.g:18143:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalProcessorModel.g:18143:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalProcessorModel.g:18143:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop17:
            do {
                int alt17=2;
            ...
            // InternalProcessorModel.g:18143:40: ( ( '\\r' )? '\\n' )?
            int alt19=2;
            ...
            switch (alt19) {
                case 1 :
                    // InternalProcessorModel.g:18143:41: ( '\\r' )? '\\n'
                    {
                    // InternalProcessorModel.g:18143:41: ( '\\r' )?
                    int alt18=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProcessorModel.g:18145:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalProcessorModel.g:18145:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalProcessorModel.g:18145:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt20=0;
            loop20:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalProcessorModel.g:18147:16: ( . )
            // InternalProcessorModel.g:18147:18: .
            {
            matchAny(); 
