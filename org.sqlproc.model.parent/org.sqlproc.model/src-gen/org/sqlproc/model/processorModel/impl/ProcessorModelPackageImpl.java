...
public class ProcessorModelPackageImpl extends EPackageImpl implements ProcessorModelPackage
{
   ...
   * @generated
   */
  private EClass annotationDefinitionModelEClass = null;
   ...
   * @generated
   */
  private EClass annotatedFeatureEClass = null;
   ...
   * @generated
   */
  public EReference getArtifacts_Annotations()
  {
   ...
   * @generated
   */
  public EReference getPojogenProperty_ColumnAnnotations()
  {
    return (EReference)pojogenPropertyEClass.getEStructuralFeatures().get(32);
  }
   ...
   * @generated
   */
  public EReference getDaogenProperty_ColumnAnnotations()
  {
    return (EReference)daogenPropertyEClass.getEStructuralFeatures().get(12);
  }
   ...
   * @generated
   */
  public EClass getAnnotationDefinitionModel()
  {
    return annotationDefinitionModelEClass;
  }
   ...
   * @generated
   */
  public EAttribute getAnnotationDefinitionModel_Name()
  {
    return (EAttribute)annotationDefinitionModelEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getAnnotationDefinitionModel_Class()
  {
    return (EAttribute)annotationDefinitionModelEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getAnnotationDefinitionModel_Classx()
  {
    return (EReference)annotationDefinitionModelEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EClass getAnnotatedFeature()
  {
    return annotatedFeatureEClass;
  }
   ...
   * @generated
   */
  public EReference getAnnotatedFeature_Annotations()
  {
    return (EReference)annotatedFeatureEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getAnnotatedFeature_Feature()
  {
    return (EReference)annotatedFeatureEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EAttribute getFeature_Final()
  {
  ...
  {
    return (EAttribute)pojoAttributeEClass.getEStructuralFeatures().get(1);
  }
  ...
  {
    return (EReference)pojoAttributeEClass.getEStructuralFeatures().get(3);
  }
  ...
  {
    return (EReference)pojoProcedureEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getDaoEntity_Features()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(artifactsEClass, ARTIFACTS__ANNOTATIONS);
    ...
    createEReference(pojogenPropertyEClass, POJOGEN_PROPERTY__COLUMN_ANNOTATIONS);
    ...
    createEReference(daogenPropertyEClass, DAOGEN_PROPERTY__COLUMN_ANNOTATIONS);
    ...
    annotationDefinitionModelEClass = createEClass(ANNOTATION_DEFINITION_MODEL);
    createEAttribute(annotationDefinitionModelEClass, ANNOTATION_DEFINITION_MODEL__NAME);
    createEAttribute(annotationDefinitionModelEClass, ANNOTATION_DEFINITION_MODEL__CLASS);
    createEReference(annotationDefinitionModelEClass, ANNOTATION_DEFINITION_MODEL__CLASSX);
    ...
    annotatedFeatureEClass = createEClass(ANNOTATED_FEATURE);
    createEReference(annotatedFeatureEClass, ANNOTATED_FEATURE__ANNOTATIONS);
    createEReference(annotatedFeatureEClass, ANNOTATED_FEATURE__FEATURE);

    featureEClass = createEClass(FEATURE);
    createEAttribute(featureEClass, FEATURE__FINAL);
    ...
    createEReference(daoEntityEClass, DAO_ENTITY__FEATURES);
  ...
  public void initializePackageContents()
  {
    ...
    pojoAttributeEClass.getESuperTypes().add(this.getFeature());
    pojoProcedureEClass.getESuperTypes().add(this.getFeature());
    ...
    initEReference(getArtifacts_Annotations(), this.getAnnotationDefinitionModel(), null, "annotations", null, 0, -1, Artifacts.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDaogenProperty_ColumnAnnotations(), this.getAnnotationAssignement(), null, "columnAnnotations", null, 0, 1, DaogenProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(annotationDefinitionModelEClass, AnnotationDefinitionModel.class, "AnnotationDefinitionModel", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getAnnotationDefinitionModel_Name(), ecorePackage.getEString(), "name", null, 0, 1, AnnotationDefinitionModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getAnnotationDefinitionModel_Class(), ecorePackage.getEString(), "class", null, 0, 1, AnnotationDefinitionModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getAnnotationDefinitionModel_Classx(), theTypesPackage.getJvmType(), null, "classx", null, 0, 1, AnnotationDefinitionModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDirectiveProperties_Features(), this.getFeature(), null, "features", null, 0, -1, DirectiveProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getPojoEntity_Features(), this.getAnnotatedFeature(), null, "features", null, 0, -1, PojoEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(annotatedFeatureEClass, AnnotatedFeature.class, "AnnotatedFeature", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getAnnotatedFeature_Annotations(), this.getAnnotation(), null, "annotations", null, 0, -1, AnnotatedFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getAnnotatedFeature_Feature(), this.getFeature(), null, "feature", null, 0, 1, AnnotatedFeature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(featureEClass, Feature.class, "Feature", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getFeature_Final(), ecorePackage.getEBoolean(), "final", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDaoEntity_Features(), this.getAnnotatedFeature(), null, "features", null, 0, -1, DaoEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
