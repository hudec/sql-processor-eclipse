 ...
 *   <li>{@link org.sqlproc.model.processorModel.impl.DaogenPropertyImpl#getColumnAnnotations <em>Column Annotations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DaogenPropertyImpl extends MinimalEObjectImpl.Container implements DaogenProperty
{
  ...
  public NotificationChain basicSetColumnAnnotations(AnnotationAssignement newColumnAnnotations, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.DAOGEN_PROPERTY__COLUMN_ANNOTATIONS, oldColumnAnnotations, newColumnAnnotations);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setColumnAnnotations(AnnotationAssignement newColumnAnnotations)
  {
    if (newColumnAnnotations != columnAnnotations)
    {
      ...
      if (columnAnnotations != null)
        msgs = ((InternalEObject)columnAnnotations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorModelPackage.DAOGEN_PROPERTY__COLUMN_ANNOTATIONS, null, msgs);
      if (newColumnAnnotations != null)
        msgs = ((InternalEObject)newColumnAnnotations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorModelPackage.DAOGEN_PROPERTY__COLUMN_ANNOTATIONS, null, msgs);
      msgs = basicSetColumnAnnotations(newColumnAnnotations, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorModelPackage.DAOGEN_PROPERTY__COLUMN_ANNOTATIONS, newColumnAnnotations, newColumnAnnotations));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case ProcessorModelPackage.DAOGEN_PROPERTY__COLUMN_ANNOTATIONS:
