...
public class ProcessorModelSemanticSequencer extends XbaseWithAnnotationsSemanticSequencer {
	...
	protected void sequence_DaoDirective(ISerializationContext context, DaoDirectivePojo semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDaoDirectiveAccess().getPojoPojoEntityQualifiedNameParserRuleCall_5_2_1_0_1(), semanticObject.eGet(ProcessorModelPackage.Literals.DAO_DIRECTIVE_POJO__POJO, false));
		feeder.finish();
	}
	...
	protected void sequence_PojoAttributeDirective(ISerializationContext context, PojoAttributeDirectiveCreateCol semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPojoAttributeDirectiveAccess().getCreateColumn1PojoAttributeValidIDParserRuleCall_7_3_0_1(), semanticObject.eGet(ProcessorModelPackage.Literals.POJO_ATTRIBUTE_DIRECTIVE_CREATE_COL__CREATE_COLUMN1, false));
	...
	protected void sequence_PojoAttributeDirective(ISerializationContext context, PojoAttributeDirectiveUpdateCol semanticObject) {
		...
		feeder.accept(grammarAccess.getPojoAttributeDirectiveAccess().getUpdateColumn2PojoAttributeValidIDParserRuleCall_6_5_0_1(), semanticObject.eGet(ProcessorModelPackage.Literals.POJO_ATTRIBUTE_DIRECTIVE_UPDATE_COL__UPDATE_COLUMN2, false));
		feeder.finish();
	}
