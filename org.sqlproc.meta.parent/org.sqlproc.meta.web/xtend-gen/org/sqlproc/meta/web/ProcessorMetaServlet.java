...
public class ProcessorMetaServlet extends XtextServlet {
  ...
  public void init() {
    try {
        ...
        public ExecutorService get() {
          ...
          final Procedure1<ExecutorService> _function = new Procedure1<ExecutorService>() {
            ...
            public void apply(final ExecutorService it) {
              ProcessorMetaServlet.this.executorServices.add(it);
            }
          };
      ...
      ProcessorMetaWebSetup _processorMetaWebSetup = new ProcessorMetaWebSetup(executorServiceProvider);
      _processorMetaWebSetup.createInjectorAndDoEMFRegistration();
    } catch (Throwable _e) {
