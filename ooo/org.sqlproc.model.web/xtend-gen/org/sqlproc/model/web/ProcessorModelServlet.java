...
import org.sqlproc.model.web.ProcessorModelWebSetup;
...
public class ProcessorModelServlet extends XtextServlet {
  ...
  public void init() {
    try {
      ...
      _processorModelWebSetup.createInjectorAndDoEMFRegistration();
    } catch (Throwable _e) {
